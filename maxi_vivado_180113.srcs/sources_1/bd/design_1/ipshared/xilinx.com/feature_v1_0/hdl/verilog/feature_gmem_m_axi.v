...
module feature_gmem_m_axi_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH      = 16,
    DEPTH_BITS = 4
...
module feature_gmem_m_axi_decoder
#(parameter
    DIN_WIDTH       = 3
)(
...
module feature_gmem_m_axi_throttl
#(parameter
    USED_FIX       = 0,
    FIX_VALUE      = 4
)(
...
module feature_gmem_m_axi_read
#(parameter
    C_M_AXI_ID_WIDTH        = 1,
    C_M_AXI_ADDR_WIDTH      = 32,
    C_TARGET_ADDR     = 32'h00000000,
...
module feature_gmem_m_axi_write
#(parameter
    C_M_AXI_ID_WIDTH        = 1,
    C_M_AXI_ADDR_WIDTH      = 32,
    C_TARGET_ADDR     = 32'h00000000,
